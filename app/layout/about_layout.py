    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                html.P(
                    "Información general del proyecto, versión, créditos y notas de desarrollo."
                ),
            ],
        ),
        # Card: Version
        html.Div(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        html.P(
                            "Versión instalada: v0.1.2"
                        )  # Puedes actualizarlo manualmente o por callback
                    ],
                ),
            ],
        ),
                ...
                html.Div(
                    ...
                    children=[
                        html.Ul(
                            [
                                html.Li(
                                    "v0.1.2 — Added VERSIONING.md and release automation."
                                ),
                                html.Li(
                                    "v0.1.0 — Added documentation module and theory renderer."
                                ),
                                html.Li(
                                    "v0.0.x — Core architecture, UI, numerical modules."
                                ),
                            ]
                        )
                    ],
