                    ...
                    children=[
                        ...
                        html.Div(
                            ...
                            children=[
                                ...
                                styled_input(
                                    id="interp-a", type="number", placeholder="a"
                                ),
                                html.Div(
                                    className="label-with-tooltip",
                                    children=[
                                ...
                                styled_input(
                                    id="interp-b", type="number", placeholder="b"
                                ),
                            ],
                        ),
                        html.Div(
                        ...
                        styled_input(
                            id="interp-n", type="number", placeholder="ej: 10"
                        ),
                    ],
                ),
                # ─────────────────────────────────────────────
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Upload(
                            id="interp-upload",
                            children=html.Div(
                                ["Arrastra o ", html.A("selecciona un archivo")]
                            ),
