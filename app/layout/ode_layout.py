        ...
        html.Div(
            ...
            children=[
                html.Div(
                    ...
                    children=[
                        html.Div(
                            "Condiciones de frontera (Shooting)", className="na-label"
                        ),
                        ...
                        html.Div(
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        html.Div(
                                            "Pendiente inicial s₀", className="na-label"
                                        ),
                        ...
                        html.Div(
                            children=[
                                html.Div(
                                    ...
                                    children=[
                                        html.Div(
                                            "n (subdivisiones)", className="na-label"
                                        ),
