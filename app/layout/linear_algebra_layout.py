...
linear_algebra_section = html.Div(
    ...
    children=[
        ...
        html.Div(
            ...
            children=[
                ...
                styled_radioitems(
                    ...
                    options=[
                        {
                            "label": "Operaciones con matrices",
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dash_table.DataTable(
                            id="la-table-A",
                            columns=[
                                {"name": f"col{i}", "id": f"col{i}", "editable": True}
                                for i in range(3)
                            ],
        ...
        # Área de resultados
        # ───────────────────────────────────────────────
        html.Div(id="linear-algebra-result-area", className="result-area"),
    ],
)
